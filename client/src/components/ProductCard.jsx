...
const ProductCard = ({product}) => {
    ...
    const {currency,addToCart,removeFromCart, cartItems,navigate,setSearchQuery,searchQuery } = useAppContext()
                ...
                <div className="flex items-end justify-between mt-3">
                    ...
                    <div onClick={(e)=>{e.stopPropagation(); }} className="text-primary">
                        {!cartItems[product._id] ? (
                            <button className="flex items-center justify-center gap-1 bg-primary-100 border border-primary md:w-[80px] w-[64px] h-[34px] rounded text-primary-dull font-medium cursor-pointer" onClick={() => addToCart(product._id)} >
